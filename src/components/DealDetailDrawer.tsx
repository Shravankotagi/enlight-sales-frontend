                          ...
                          return (
                            <tr key={i} className="hover:bg-gray-50">
                              ...
                              <td className="px-3 py-2 text-gray-800 text-xs">
                                {rate > 0 ? `Rs.${Number(rate).toLocaleString('en-IN')}` : '-'}
                              </td>
                              <td className="px-3 py-2 text-gray-800 text-xs font-semibold">
                                {amount > 0 ? `Rs.${Number(amount).toLocaleString('en-IN')}` : '-'}
                              </td>
                            </tr>
                          );
                        })}
              ...
              <div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">Rs.{Number(totalAmount).toLocaleString('en-IN')}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">GST (18%)</span>
                    <span className="font-medium">Rs.{Number(gst).toLocaleString('en-IN')}</span>
                  </div>
                  <div className="flex justify-between text-sm font-bold border-t border-blue-200 pt-2">
                    <span className="text-gray-800">Grand Total</span>
                    <span className="text-blue-700">Rs.{Number(grandTotal).toLocaleString('en-IN')}</span>
                  </div>
                        ...
                        return (
                          <div key={item.id || `item-${i}`} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-right">
                              <p className="text-xs font-semibold text-gray-800">Rs.{calculated.rate.toLocaleString('en-IN')}/{calculated.unit || 'MT'}</p>
                              <p className="text-xs text-gray-500">Rs.{calculated.amount.toLocaleString('en-IN')}</p>
                            </div>
                          </div>
                        );
                      })}
                        ...
                        return (
                          <div className="border-t pt-3 space-y-1">
                            ...
                            <div className="flex justify-between text-sm font-bold">
                              ...
                              <span className="text-blue-700">Rs.{pricing.grandTotal.toLocaleString('en-IN')}</span>
                            </div>
                          </div>
                        );
                      })()}
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 text-xs text-slate-700 space-y-1.5 mb-5">
              ...
              {totalAmount > 0 && (
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-emerald-600">Rs.{Number(totalAmount).toLocaleString('en-IN')}</span>
                </div>
              )}
